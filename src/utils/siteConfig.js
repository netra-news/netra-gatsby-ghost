module.exports = {
    siteUrl: `https://storage.googleapis.com/netra.news`, // Site domain. Do not include a trailing slash!
    ...
    shortTitle: `Netra News`, // Used for App manifest e.g. Mobile Home Screen
